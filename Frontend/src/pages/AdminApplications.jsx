...
import { FiUserCheck, FiCheck, FiX, FiFileText, FiMail, FiPhone, FiInbox } from 'react-icons/fi'
...
export default function AdminApplications() {
  ...
  useEffect(() => {
    if (user?.is_admin) fetchApplications()
  }, [user])

  // Admin-only page — regular patients get sent home
    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8">
      <div className="mb-6 animate-slide-up">
        ...
        <p className="text-gray-400 text-sm mt-1">
          Review credentials and activate new doctors on the platform.
        </p>
      </div>
